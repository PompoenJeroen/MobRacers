...
public class BooItem extends Item
{
    ...
    public BooItem()
    {
        ...
        this.pitchs.add(1.5f);
        this.pitchs.add(1.25f);
        this.pitchs.add(1f);
        this.pitchs.add(0.75f);
    ...
    {	return me.winterguardian.mobracers.item.ItemType.BOO;
    }
    ...
    public ItemStack getItemStack()
    {
        ...
        itemMeta.setDisplayName("§r§f§l" + CourseMessage.ITEM_SPECIAL_GUARDIAN.toString());
    ...
    private class ScarePlayers implements Runnable
    {
        ...
        public void run()
        {
            for(Player p : victims)
            {
                ...
                {
                    ParticleUtil.playSimpleParticles(p, p.getEyeLocation(), ParticleType.MOB_APPEARANCE, 0, 0, 0, 0, 10);
                    new SoundEffect("mob.ghast.scream", 1, pitchs.get(pitchs.size() - i)).play(p, p.getEyeLocation());
                }
            }
