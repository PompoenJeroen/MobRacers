...
public class ShieldItem extends Item
{
	...
	private static ParticleData shieldParticle = new ParticleData(ParticleType.SPELL_MOB_AMBIENT, 0, 0, 0, 2, 25, (int[])null);
...
//Play sound at 100% volume
...

		{
			...
			vehicle.setSpeed(vehicle.getSpeed() + 0.25f);
			player.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 120, 1, false, true));
		}
