...
public class ArenaSelectionState extends WaitingState implements MobRacersState
{
	...
	public void giveStuff(Player player)
	{
		...
		ItemStack rails = new ItemStack(Material.DETECTOR_RAIL, 1);

		ItemMeta railsMeta = rails.getItemMeta();
		railsMeta.setDisplayName(CourseMessage.ARENASELECT_GUI_ITEM.toString());
		rails.setItemMeta(railsMeta);

		player.getInventory().setItem(0, rails);
