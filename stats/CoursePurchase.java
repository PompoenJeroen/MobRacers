...
public class CoursePurchase
{
	...
	public static final CoursePurchase SLIME = new CoursePurchase(VehicleType.SLIME, config.getInt("vehicle.slime.price",3_000));
	public static final CoursePurchase RABBIT = new CoursePurchase(VehicleType.RABBIT, config.getInt("vehicle.rabbit.price", 4_000));
	public static final CoursePurchase SQUID = new CoursePurchase(VehicleType.SQUID, config.getInt("vehicle.squid.price", 5_000));
	public static final CoursePurchase WOLF = new CoursePurchase(VehicleType.WOLF, config.getInt("vehicle.wolf.price", 6_000));
	public static final CoursePurchase ZOMBIE = new CoursePurchase(VehicleType.ZOMBIE, config.getInt("vehicle.zombie.price", 7_000));
	public static final CoursePurchase CHICKEN = new CoursePurchase(VehicleType.CHICKEN, config.getInt("vehicle.chicken.price", 8_000));
