...
public class OcelotVehicle extends WinnableVehicle
{
	...
	@Override
	public me.winterguardian.mobracers.stats.CourseAchievement getWinAchievement()
	{
		return me.winterguardian.mobracers.stats.CourseAchievement.OCELOT_PLAYED;
	}
	...
	{
		return new VehicleGUIItem(getType(), 49, Material.MONSTER_EGG, 1, (short)98, "§9§l" + getName(), new ArrayList<String>());
	}
}
