...
public class CourseMessage extends LangMessage
{
	...
	STANDBY_BOARD1 = new CourseMessage("standby-board1", false),
	STANDBY_BOARD2 = new CourseMessage("standby-board2", false),
	STANDBY_BOARD3 = new CourseMessage("standby-board3", false),
	...
	ARENASELECT_GUI_ITEM = new CourseMessage("arenaselect-gui-item", false),
	...
	VEHICLESELECT_GUI_ITEM = new CourseMessage("vehicleselect-gui-item", false),
	...
	GAME_COMPASS_NAME = new CourseMessage("game-compass-name", false),
	GAME_COMPASS_LORE = new CourseMessage("game-compass-lore", false),
	
	GAME_LEAVEITEM_NAME = new CourseMessage("game-leaveitem-name", false),
	GAME_LEAVEITEM_LORE = new CourseMessage("game-leaveitem-lore", false),
	...
	ACHIEVEMENT_OCELOT_DESC = new CourseMessage("achievement-ocelot-desc", false),

	ACHIEVEMENT_OCELOT_NAME = new CourseMessage("achievement-ocelot-name", false),

	ACHIEVEMENT_OCELOT_UNLOCK = new CourseMessage("achievement-ocelot-unlock", false),
	...
	ITEM_LIGHTNING = new CourseMessage("item-lightning", false),

	ITEM_FIREBALL = new CourseMessage("item-fireball", false),

	SPECIAL_ITEM_CREEPER = new CourseMessage("special-item-creeper", false),
	...
	ITEM_SPECIAL_ZOMBIE = new CourseMessage("item-special-zombie", false),
	...
	VEHICLE_ZOMBIE_NAME = new CourseMessage("vehicle-zombie-name", false),
	VEHICLE_ZOMBIE_DESC = new CourseMessage("vehicle-zombie-desc", false),

	VEHICLE_ZOMBIE_LORE = new CourseMessage("vehicle-zombie-lore", false),

	VEHICLE_CREEPER_NAME = new CourseMessage("vehicle-creeper-name", false),

	VEHICLE_CREEPER_DESC = new CourseMessage("vehicle-creeper-desc", false),
